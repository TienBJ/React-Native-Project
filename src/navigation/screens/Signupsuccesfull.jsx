...
export const SignSuccessNotification = ({ navigation }) => {
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.textButton}>
                <Text style={styles.textTitle}>Your Profile Is Ready To Use</Text>
                <View style={styles.buttonAction}>
                    <Pressable>
                        <Text style={styles.titleButton}>Try Order</Text>
                    </Pressable>
                </View>
            </View>
